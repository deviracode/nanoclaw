 ...
 *   SRC_DIR/            ← shared agent-runner source (RO)
 *   SKILLS_DIR/         ← shared skills (RO)
 *   /home/node/.claude/ ← Claude SDK state + skill symlinks (RW, image-fixed)
 */
...
async function main(): Promise<void> {
  ...
  // Discover additional directories mounted at EXTRA_DIR/*
